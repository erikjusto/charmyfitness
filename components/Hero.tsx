      ...
      <div className="container mx-auto px-6 relative z-10 text-left text-white">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-start">
            ...
            <button className="w-full sm:w-auto bg-[#E6B7B2] text-black py-5 px-8 rounded-xl font-bold uppercase tracking-[0.2em] text-sm flex items-center justify-center gap-3 hover:bg-white transition-all group">
              Fale com comercial 
